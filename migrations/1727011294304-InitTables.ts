...
export class InitTables1727011294304 implements MigrationInterface {
    name = 'InitTables1727011294304'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tickets" ("id" SERIAL NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "sessionId" integer, CONSTRAINT "PK_343bc942ae261cf7a1377f48fd0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "movieSessions" ("id" SERIAL NOT NULL, "roomNumber" integer NOT NULL, "date" TIMESTAMP NOT NULL, "timeSlot" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "movieId" integer, CONSTRAINT "PK_6256399806cc2d755cb4e097dc8" PRIMARY KEY ("id"))`);
